			...
			<div style="font-size: 1.3em;">
				...
				<li><b>Autenticación:</b> mediante par de claves pública/privada.
					<ul>
						...
						<li>El procedimiento de generación de claves puede consultarse en el siguiente <a href="http://www.fing.edu.uy/inco/cursos/hpc/material/clases/hpc2008-ambiente_pvm.pdf">enlace</a> y en sitios de Internet.</li>
					</ul>
				</li>
				</ul>
			</div>
