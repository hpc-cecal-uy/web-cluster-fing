...
$(document).ready(function(){
    ...
    addHelp('#cola_trabajo',
        '<b>Cola de ejecuci&oacute;n del trabajo:</b><ul>' +
            ...
            '<table cellspacing="3px" cellpadding="0px"><tr style="font-weight:bold;"><td>Nombre</td><td>M&iacute;n. CPU</td><td>M&aacute;x. CPU</td><td>M&aacute;x. de walltime</td></tr>' +
            '<tr><td>serial</td><td>1</td><td>1</td><td>240 hs.</td></tr>' +
            '<tr><td>small_jobs</td><td>2</td><td>16</td><td>240 hs.</td></tr>' +
            '<tr><td>medium_jobs</td><td>17</td><td>32</td><td>96 hs.</td></tr>' +
            '<tr><td>big_jobs</td><td>33</td><td>--</td><td>48 hs.</td></tr>' +
            '<tr><td>quick_jobs</td><td>1</td><td>24</td><td>2 hs.</td></tr>' +
            '</table></li>'+
        '</ul>');
